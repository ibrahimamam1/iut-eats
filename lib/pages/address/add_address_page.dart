...
import 'package:iut_eats/models/address_model.dart';
import 'package:iut_eats/pages/address/pick_address_map.dart';
...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold( // Fixed spelling from Sacaffold to Scaffold
      appBar: AppBar(
        title: Text("Address page"),
        backgroundColor: AppColors
            .mainColor, // Ensure AppColors is correctly imported
      ),
